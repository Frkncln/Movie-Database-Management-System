  ...
  <body>
    ...
    <?php
     ...
     //$Query = query($_POST["return-type"], $_POST["param-type"], $_POST["param-value"]);
      ...
      $Query = "SELECT * FROM Acting t1 JOIN Actor t2 ON t1.Actor_Id = t2.Person_Id JOIN Person t3 ON t3.Person_Id = t2.Person_Id JOIN Shows t4 ON t1.Show_Id = t4.Show_Id WHERE t3.First_Name LIKE '%".$_POST["actor"]."%' or t3.Last_Name LIKE '%".$_POST["actor"]."%' or CONCAT(t3.First_name,' ',t3.Last_name) ='".$_POST["actor"]."';";
