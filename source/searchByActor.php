...
<html>
  ...
  <body>
    ...
    <main class="container">
      ...
      <form role="form" action="searchByActorResult.php" method="post">



        <div class="form-group">
          <label for="actor">Enter the Actor Name</label>
          <input name="actor" type="text" class="form-control" id="actor" placeholder="Input Actor">
        </div>
