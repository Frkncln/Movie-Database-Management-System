...
<html>
  ...
  <body>
    ...
    <main class="container">
      ...
      <form role="form" action="addDirectorResult.php" method="post">
        ...
        <div class="form-group">
          <label for="gender">where the</label>
        ...
        <div class="form-group">
          <label for="drt">Direction Type</label>
          <select name="drt" class="form-control" id="drt">
            <option>Movie</option>
            <option>Music</option>
          </select>
        </div>
        ...
        <div class="form-group">
          <label for="sncyr"> Start Date</label>
