  ...
  <body>
    ...
    <?php
     ...
     //$Query = query($_POST["return-type"], $_POST["param-type"], $_POST["param-value"]);
      ...
      $Query = "INSERT INTO Person (Gender, First_Name, Middle_Name,Last_Name , DOB) VALUES ('".$_POST["gender"]."','".$_POST["fname"]."',null,'".$_POST["lname"]."','".$_POST["bdate"]."');";
      $SubQuery = "INSERT INTO Actor (Person_Id, Worth, StartDate) VALUES ( (SELECT Person_Id FROM Person WHERE 
