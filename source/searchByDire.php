...
<html>
  ...
  <body>
    ...
    <main class="container">
      ...
      <form role="form" action="searchByDireResult.php" method="post">



        <div class="form-group">
          <label for="Dire">Enter the Director Name</label>
          <input name="Dire" type="text" class="form-control" id="Dire" placeholder="Input Director">
        </div>
