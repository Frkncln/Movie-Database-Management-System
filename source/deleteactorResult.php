  ...
  <body>
    ...
    <?php
     ...
     //$Query = query($_POST["return-type"], $_POST["param-type"], $_POST["param-value"]);
      ...
      $Query = "DELETE FROM Actor WHERE Person_Id =  (SELECT Person_Id FROM Person WHERE 
                    First_Name = '".$_POST["fname"]."' AND Last_Name = '".$_POST["lname"]."' );";
      
      $SubQuery = "DELETE FROM Person  WHERE First_Name = '".$_POST["fname"]."' AND Last_Name = '".$_POST["lname"]."' ;";

      
	$Result_Type="deleteactor";
